    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            ...
            <div class="d-none d-md-block search-form" style="margin-left:20px;">
                <form class="d-flex">
                    <input class="form-control me-2 search-input" type="search" placeholder="{{ __('search') }}" aria-label="Search">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item position-relative">
                        <a class="nav-link" href="{{ route('chat.index') }}">
                            <svg class="bi" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width="20" height="20">
                    ...
                    <li class="nav-item position-relative">
                        <a class="nav-link" href="#">
                            <svg class="bi" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="20" height="20">
