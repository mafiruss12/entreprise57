...
@include('layouts.sidebar')
    ...
    <div class="container">
    <form action="{{ route('chat.sendMessage') }} method="POST"><div class="row clearfix" >
        <div class="col-lg-12">
            <div class="card chat-app" >
                <div id="plist" class="people-list">
                    ...
                    <ul class="list-unstyled chat-list mt-2 mb-0">
                        ...
                        <li class="clearfix user" data-id="{{ $user->id }}">
                ...
                <div class="chat" style="height:80vh">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="chat-about">
                                    <h6 class="m-b-0" id="chat-with">Select a user to chat</h6>
                                    <small></small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="chat-history" id="chat-history">
                        <ul class="m-b-0" id="messages-list">
                        </ul>
                    </div>
                    <div class="chat-message clearfix" style="position:relative;top:350px">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.user').forEach(function (user) {
        user.addEventListener('click', function () {
            ...
            document.getElementById('chat-with').innerText = this.querySelector('.name').innerText;
            ...
            .then(data => {
                ...
                data.messages.forEach(function (message) {
                    ...
                    if (message.sender_id == {{ Auth::id() }}) {
                        messageElement.innerHTML = `<div class="message-data"><span class="message-data-time">${message.created_at}</span></div><div class="message my-message">${message.content}</div>`;
                    } else {
                        messageElement.innerHTML = `<div class="message-data text-right"><span class="message-data-time">${message.created_at}</span><img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="avatar"></div><div class="message other-message float-right">${message.content}</div>`;
                    }
    ...
    function sendMessage(userId, message) {
        ...
        .then(data => {
            if (data.success) {
                ...
                const messageElement = document.createElement('li');
                messageElement.classList.add('clearfix');
                messageElement.innerHTML = `<div class="message-data"><span class="message-data-time">${data.message.created_at}</span></div><div class="message my-message">${data.message.content}</div>`;
                messagesList.appendChild(messageElement);
            }
        });
    }
